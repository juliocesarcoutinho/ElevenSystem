    ...
    const SalvarUsuario = async () => {
        ...
        const usuario = {
            ...
            roles: dropdownItem ? [{
                ...
                name: dropdownItems.find(item => item.code === dropdownItem)?.name || ''
            }] : []
                    ...
                    <>
                        ...
                        <div className="py-2 p-fluid formgrid grid">
                            <div className="field col-12 md:col-6">
                                ...
                                {validationError.name && <small className="p-error">O nome é obrigatório</small>}
                            </div>
                            ...
                            <div className="field col-12 md:col-6">
                                ...
                                {validationError.password && <small className="p-error">A senha é obrigatória</small>}
                            </div>
